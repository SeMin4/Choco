...
public class Shelter extends NMapActivity {
    ...
    // initialize map view
        ...
        onMapInitHandler(mMapView,null);
        ...
        mMyLocationOverlay = mOverlayManager.createMyLocationOverlay(nMapLocationManager, nMapCompassManager);
    ...
    private final NMapLocationManager.OnLocationChangeListener onMyLocationChangeListener = new NMapLocationManager.OnLocationChangeListener() {
        ...
        public void onLocationUpdateTimeout(NMapLocationManager locationManager) {
            ...
            Toast.makeText(Shelter.this, "", Toast.LENGTH_SHORT).show();
